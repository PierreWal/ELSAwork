...
subtitle: Exploratory analysis  - draft version 5
...
1. Search and add missing variables (Self perceived age; Life Expectancy expectation; Caring responsibility; Interest in politics; Charity association member;  I want to give back to my community; grandchildren.)
...
for (v in bivars19[-c(1,2)]) {
  ...
  elsaw |>
    ...
    lapply(function(sub_elsaw) {
      ...
      tab <- table(sub_elsaw[[fn]], sub_elsaw$VotGE19.fr)
...
This section presents the results of four series of stepwise logistic regressions models of voter turnout at the 2019 general elections:
