...
`{r} labs[["hltprhb.f"]]`  | hltprhb    | `{r} attr(ess$hltprhb,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprhb.fr)))[1],big.mark = ",")` 
`{r} labs[["hltpral.f"]]`  | hltpral    | `{r} attr(ess$hltpral,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltpral.fr)))[1],big.mark = ",")` 
`{r} labs[["hltprbn.f"]]`  | hltprbn    | `{r} attr(ess$hltprbn,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprbn.fr)))[1],big.mark = ",")`
`{r} labs[["hltprpa.f"]]`  | hltprpa    | `{r} attr(ess$hltprpa,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprpa.fr)))[1],big.mark = ",")` 
`{r} labs[["hltprpf.f"]]`  | hltprpf    | `{r} attr(ess$hltprpf,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprpf.fr)))[1],big.mark = ",")` 
`{r} labs[["hltprsd.f"]]`  | hltprsd    | `{r} attr(ess$hltprsd,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprsd.fr)))[1],big.mark = ",")`
`{r} labs[["hltprsc.f"]]`  | hltprsc    | `{r} attr(ess$hltprsc,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprsc.fr)))[1],big.mark = ",")` 
`{r} labs[["hltprsh.f"]]`  | hltprsh    | `{r} attr(ess$hltprsh,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprsh.fr)))[1],big.mark = ",")` 
`{r} labs[["hltprdi.f"]]`  | hltprdi    | `{r} attr(ess$hltprdi,"label")` |`{r} prettyNum(as.numeric(table(is.na(ess$hltprdi.fr)))[1],big.mark = ",")` 
...
# ess$dimarr.fr<-relevel(ess$dimarr.fr,ref=2)
# ess$tenureb.fr<-relevel(ess$tenureb.fr,ref=2)
# ess$edqual.fr<-relevel(ess$edqual.fr,ref=4)
