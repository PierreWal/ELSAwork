# ESS voting pattern study Version 3
...
source("syntax/labels_ess_uk.R")

datadir<-"~/Data/ess/ESS11/"

ess.raw<-read_dta(paste0(datadir,"ESS11.dta")) 
ess<-ess.raw |>filter(cntry=="GB" & agea>50) |>
...
```{r recode}
source("syntax/recoding_ess_uk.R")
``` 
...
Version 3 
- UK-only  analysis on a separate  page
